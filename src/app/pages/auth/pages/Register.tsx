    ...
    <div className=" max-w-4xl flex items-center mx-auto md:min-h-screen p-4">
      <div className="grid md:grid-cols-3 items-center [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)] rounded-xl overflow-hidden">
        <div className="max-md:order-1 flex flex-col justify-center md:space-y-16 space-y-8 max-md:mt-16 min-h-full bg-gradient-to-l from-math to-math lg:px-8 px-4 py-4">
          <div>
            <h3 className="text-geo text-lg">Crie sua conta</h3>
            <p className=" text-primary-foreground mt-3 leading-relaxed">Bem-vindo(a) à nossa página de cadastro! Comece criando sua conta.</p>
          </div>
          <div>
            <h3 className="text-geo text-lg">Registro simples e seguro</h3>
            <p className="text-primary-foreground mt-3 leading-relaxed">Nosso processo de cadastro foi desenvolvido para ser simples e seguro. Priorizamos sua privacidade e a segurança dos seus dados.</p>
          </div>
        </div>


        <form onSubmit={handleRegister} className="md:col-span-2 w-full py-6 px-6 sm:px-14 max-w-lg mx-auto">
          <div className="mb-8">
            <h1 className="text-geo  text-2xl font-bold">Cadastre-se agora</h1>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="relative flex items-center">
                <input name="name" type="text" required className="text-slate-900 bg-white border border-slate-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Nome" onChange={(e) => setName(e.target.value)} />
          ...
          <p className="text-slate-600 text-sm mt-6 text-center" >Já tem uma conta? <a href="/login" className="text-blue-600 font-medium hover:underline ml-1">Acessar conta</a></p>
        </form>
      </div>
    </div>
  )
